export const en = {
  "pwa.appDescription": "A calm, routine-first way to shape each day.",
  "pwa.checkinShortcut": "Open today’s daily check-in.",
  "pwa.addTaskShortcut": "Add one thing to remember.",
  "pwa.offlineTitle": "You’re offline for now.",
  "pwa.offlineBody": "You can keep using what’s already open. Routine, task and check-in changes will wait for the next sync.",
  "pwa.pendingTitle": "Changes waiting to sync",
  "pwa.pending": "{count} changes are waiting to sync.",
  "pwa.syncing": "Syncing your saved changes…",
  "pwa.syncError": "Your saved changes are still on this device, but they could not sync yet.",
  "pwa.retrySync": "Try syncing again",
  "pwa.updateTitle": "A Rootine update is ready",
  "pwa.updateBody": "Reload when you’re ready to switch to the new version.",
  "pwa.updateAction": "Update and reload",
  "common.save": "Save",
  "common.tomorrow": "Tomorrow",
  "common.yesterday": "Yesterday",
  "login.resend": "Resend confirmation email",
  "login.resending": "Sending…",
  "login.resent": "A fresh confirmation email was sent.",
  "login.resendError": "Couldn’t resend the confirmation email. Try again in a moment.",
  "login.createError": "Couldn’t create your account. Try again.",
  "auth.invalidCredentials": "Email or password doesn’t match. Check both and try again.",
  "auth.emailNotConfirmed": "Confirm your email first, then come back and sign in.",
  "auth.rateLimited": "Too many tries for now. Give it a minute, then try again.",
  "auth.userBanned": "This account can’t sign in right now.",
  "auth.signInFailed": "Couldn’t sign you in right now. Try again in a moment.",
  "streak.checkedToday": "You showed up today. Completion does not need to be perfect for the rhythm to count.",
  "streak.openToday": "Your rhythm is still alive. A check-in today keeps it moving.",
  "streak.inactive": "A finished check-in today starts a new rhythm. The goal is returning, not being perfect.",
  "password.strength.weak": "Password strength: weak",
  "password.strength.fair": "Password strength: fair",
  "password.strength.strong": "Password strength: strong",
  "password.guidance": "Use at least {count} characters; mixing letters, numbers and symbols makes it stronger.",
  "settings.feedbackTitle": "Help us improve rootine",
  "settings.feedbackBody": "Send feedback without keeping it in your everyday navigation.",
  "settings.feedbackAction": "Send feedback",
  "dashboard.dayOneTitle": "Start with one small thing.",
  "dashboard.dayOneBody": "Add a routine or task. Your rhythm will grow from what you actually do.",
  "dashboard.setupReminder": "Set a reminder when you’re ready",
  "dashboard.upNext": "Up next",
  "dashboard.timedDone": "Your timed items are settled for today.",
  "form.required": "Required.",
  "health.uniqueTimes": "Choose each reminder time only once.",
  "workout.durationRange": "Use a duration from 1 to 1440 minutes.",
  "checkin.completeRemaining": "Complete remaining",
  "onboarding.quickStart": "Or start from a simple idea",
  "onboarding.template.water": "Drink water",
  "onboarding.template.walk": "Take a short walk",
  "onboarding.template.read": "Read a few pages",
  "guide.replay": "Replay the introduction",
  ...
  "settings.personal": "Personalize",
  "settings.personalBody": "Your name, appearance and language.",
  "settings.device": "App & reminders",
  ...
  "dashboard.firstSuccessEyebrow": "You’re set up",
  "dashboard.firstSuccessTitle": "“{name}” is ready for today.",
  "dashboard.firstSuccessBody":
    "When you do it, check it off here. That first small completion is enough to start your rhythm.",
  "dashboard.lifeBody":
  ...
  "dashboard.healthToday": "Health today",
  "dashboard.sportToday": "Sport today",
  "dashboard.remindersToday": "Today’s reminders",
  "dashboard.noMedicationToday": "No medication scheduled for today.",
  "dashboard.noSportToday": "No sport sessions scheduled for today.",
  "dashboard.noRemindersToday": "Nothing timed for today.",
