export const en = {
  ...
  "onboarding.reviewContinue": "Review a starter routine",
  "onboarding.backToday": "Back to Today",
  "onboarding.addAnother": "Add routine and return to Today",
  "onboarding.starters": "Try a starter",
  "onboarding.startersBody": "Pick one to prefill the form, then change anything you like.",
  "onboarding.presetWater": "Drink water",
  "onboarding.presetWalk": "Take a short walk",
  "onboarding.presetRead": "Read 5 pages",
  "onboarding.presetStretch": "Stretch for 5 minutes",
  ...
  "routine.scheduleDaily": "Every day · {time}",
  ...
  "login.resent": "A new confirmation email is on its way.",
  "login.resendError": "Couldn’t resend the email yet. Try again in a moment.",
  "login.forgot": "Forgot password?",
  "login.signupError": "Couldn’t create your account. Try again.",
  "login.errorInvalidCredentials": "Email or password doesn’t match. Check both and try again.",
  "login.errorEmailNotConfirmed": "Confirm your email first, then come back and sign in.",
  "login.errorRateLimited": "Too many tries for now. Give it a minute, then try again.",
  "login.errorBanned": "This account can’t sign in right now.",
  "login.errorGeneric": "Couldn’t sign you in right now. Try again in a moment.",
  "password.requirement": "Use at least {count} characters. A longer passphrase is easier to remember and harder to guess.",
  "password.strength": "Strength: {strength}",
  "password.weak": "Needs more",
  "password.fair": "Fair",
  ...
  "settings.helpBody": "Replay the introduction or tell us what needs improving.",
  "settings.replayIntro": "Replay introduction",
  ...
  "dashboard.dayOneTitle": "Start with one useful thing.",
  "dashboard.dayOneBody": "Your space is intentionally quiet on day one. Add a small task or routine and rootine will build the day around what you actually use.",
  "dashboard.dayOneTask": "Add a task",
  "dashboard.dayOneRoutine": "Create a routine",
  "dashboard.reminderNudgeTitle": "Want rootine to remember with you?",
  "dashboard.reminderNudgeBody": "You’ve started using your day. You can enable device reminders in Settings when you’re ready.",
  "dashboard.reminderNudgeAction": "Review reminders",
