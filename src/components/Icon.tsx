...
const paths = {
  ...
  copy: "M9 9h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V11a2 2 0 0 1 2-2Zm6-4V4a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h1",
  rootine:
  ...
  help:
    "M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm-2.1-12a2.5 2.5 0 1 1 4.4 1.6c-.8.9-2.3 1.3-2.3 2.9m0 3.5h.01",
  health:
    "M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.7l-1.1-1.1a5.5 5.5 0 0 0-7.8 7.8L12 21l8.8-8.6a5.5 5.5 0 0 0 0-7.8ZM5.5 12h3l1.2-2.4 2.1 5 1.5-3h5.2",
  sport:
    "M13 4.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM10 7l3 2 2.5-1.5M13 9l-2 4-4 2m4-2 3 3 1 5m-4-8-2 5-4 2",
} as const;
